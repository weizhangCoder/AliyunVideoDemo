...
//    int shouldAddValue = 0b1110000000000000;
//
//    for (int i = 0; i < 16; i ++) {
//        int typeValue = 1 << i;
...
//
    ...
    AVC_ET_ModuleDefine *module = [[AVC_ET_ModuleDefine alloc]initWithModuleType:AVC_ET_ModuleType_VideoPlayConfig];
    self.dataArray = @[module];
    //CollectionView
...
//            [self configImageBundleWithType:module.type];
            switch (module.type) {
                ...
                case AVC_ET_ModuleType_VideoPlayConfig: {
                    ...
                    [self pushAVC_ET_ModuleType_VideoPlayConfig];
...
//        __weak typeof(self) weakSelf = self;
        [AlivcAppServer getAuthWithUrlString:@"https://api.test.mingchu.co/vod/auth_play" completionHandler:^(NSString * _Nullable errString, NSDictionary * _Nullable resultDic) {
