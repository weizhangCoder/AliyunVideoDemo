 ...
 */
+ (void)getAuthWithUrlString:(NSString *)urlString completionHandler:(void (^)(NSString *__nullable errString,NSDictionary *_Nullable resultDic))handle{
    
    [[self manager] GET:urlString parameters:@{} progress:^(NSProgress * _Nonnull downloadProgress) {
